...
主要功能的全方位复盘（设计思路、Mermaid 流程图、踩坑与决策记录）位于 [`doc/`](doc/README.md)：

| 文档 | 复盘对象 |
|---|---|
| [主文档：复盘总览](doc/README.md) | 项目全景、架构图、「一次导出的完整旅程」、状态机、模式沉淀 |
| [01 · 公共底座](doc/01-公共底座.md) | 统一 Envelope / 全局异常 / trace_id / multipart 挂死与异步日志两个大坑 |
| [02 · 订单查询](doc/02-订单查询.md) | 筛选排序分页 / LIKE 防注入 / 动态 SQL 共享片段 |
| [03 · 导出任务创建与幂等](doc/03-导出任务创建与幂等.md) | request hash / 幂等三态裁决 / 同事务双写 |
| [04 · 可靠投递](doc/04-可靠投递-Outbox与消费.md) | 事务性 Outbox / Publisher Confirm / CAS 抢占 / Attempt 审计 |
| [05 · 导出执行与 Excel 生成](doc/05-导出执行与Excel生成.md) | Keyset 高水位 / SXSSF 滑动窗口 / 原子发布 |
| [06 · 进度状态与 SSE 实时通知](doc/06-进度状态与SSE实时通知.md) | 事实源/投影/广播三层 / 版本栅栏 / 轮询降级 |
| [07 · 文件安全与下载](doc/07-文件安全与下载.md) | 受控根目录 / 路径双层防腐 / 下载协议 |
| [08 · 恢复与清理](doc/08-恢复与清理.md) | 租约 / 启动恢复 / 删除成功才 EXPIRED / 孤儿三维对账 |
